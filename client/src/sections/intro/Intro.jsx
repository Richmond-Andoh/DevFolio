...
const Intro = () => {
  return (
    <div className='h-[80vh] bg-primary-content flex flex-col items-start justify-center gap-9 py-10'>
        ...
        <h1 className="text-primary text-6xl sm:text-3xl font-semibold">Richmond Andoh</h1>
        <h1 className="text-white text-5xl sm:text-2xl font-semibold">I build things for the Web</h1>
